...
const AnswerDisplay = ({ answer, citations, stats }) => {
            ...
            {stats && (
                <div className="flex items-center gap-6 ml-auto">
                    <div className="flex flex-col items-end">
                        <span className="text-[9px] text-zinc-500 uppercase tracking-widest font-bold">Cost</span>
                        <span className="text-xs font-mono text-emerald-400 font-bold">${stats.cost ? stats.cost.toFixed(4) : "0.0000"}</span>
                    </div>
                    <div className="flex flex-col items-end border-l border-white/5 pl-6">
                        <span className="text-[9px] text-zinc-500 uppercase tracking-widest font-bold">Tokens</span>
                        <span className="text-xs font-mono text-blue-400 font-bold">{stats.tokens || 0}</span>
                    </div>
                </div>
            )}
        </div>
