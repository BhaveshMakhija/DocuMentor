...
def rerank():
    ...
    # Try Cohere first if credentials exist
    ...
    # Local fallback: MS-MARCO Cross-Encoder (no API key needed)
    try:
        from langchain.retrievers import ContextualCompressionRetriever
        ...
        # Final fallback: return plain hybrid retriever with no reranking
        return br
